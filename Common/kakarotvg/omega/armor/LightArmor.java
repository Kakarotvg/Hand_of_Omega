...
public class LightArmor extends ItemArmor {
    ...
    public LightArmor(int id, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String armorfile) {
    ...
    public void getSubItems(int par1, CreativeTabs par2CreativeTabs, List par3List) {
        ...
        is.addEnchantment(Enchantment.fireAspect, 8);
        is.addEnchantment(Enchantment.fireProtection, 5);
        par3List.add(is);
    }
