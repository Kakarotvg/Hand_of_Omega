...
public class OmegaArmor extends ItemArmor {
    ...
    public OmegaArmor(int id, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String armorfile) {
    ...
    public void getSubItems(int par1, CreativeTabs par2CreativeTabs, List par3List) {
        ...
        is.addEnchantment(Enchantment.flame, 4);
        is.addEnchantment(Enchantment.fireProtection, 4);
        par3List.add(is);
    }
