...
public class ContainerComputer extends Container {
    ...
    private TileEntityComputerEntity furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerComputer(InventoryPlayer par1InventoryPlayer, TileEntityComputerEntity par2TileEntityFurnace) {
        ...
        this.addSlotToContainer(new SlotVgFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                else if (TileEntityComputerEntity.isItemFuel(itemstack1)) {
