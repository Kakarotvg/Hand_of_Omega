...
public class Vgfood extends ItemFood {
    ...
    public Vgfood(int par1, int par2, float par3, boolean par4) {
    ...
    public Vgfood(int par1, int par2, boolean par3) {
     ...
     * happening
     */
    public Vgfood setPotionEffect(int par1, int par2, int par3, float par4) {
        this.potionId = par1;
