...
public class WorldGenVgTrees extends WorldGenerator {
    ...
    public WorldGenVgTrees(boolean par1) {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenVgTrees(boolean par1, int par2, int par3, int par4, boolean par5) {
        super(par1);
                ...
                if (isSoil && par4 < 256 - l - 1) {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2) {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0) {
                                    ...
                                    if (block == null || block.canBeReplacedByLeaves(par1World, j2, j1, l2)) {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, BlockHandler.tealleaf.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1) {
                        ...
                        if (k1 == 0 || block == null || block.isLeaves(par1World, par3, par4 + j1, par5)) {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, BlockHandler.teallog.blockID, this.metaWood);
