...
public class UChestGui extends GuiContainer {
    private static final ResourceLocation resourceloc = new ResourceLocation(Reference.MOD_ID, "textures/gui/chestugui.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        this.mc.getTextureManager().bindTexture(resourceloc);
