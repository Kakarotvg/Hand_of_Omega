...
public class ArmorHandler {
    ...
    /*
     * public static void setNames(LanguageRegistry register) { // urotark
     ...
     * register.addName(urotarkboots, "Urotark Boots"); // pearl
     * register.addName(pearlhelm, "Pearl Helmet"); register.addName(pearlplate,
     * "Pearl Chestplate"); register.addName(pearllegs, "Pearl Leggins");
     * register.addName(pearlboots, "Pearl Boots"); // sapphire
     ...
     * register.addName(sapphireboots, "Sapphire Boots"); // muscovite
     ...
     * register.addName(muscoviteboots, "Muscovite Boots"); // ruby
     * register.addName(rubyhelm, "Ruby Helmet"); register.addName(rubyplate,
     * "Ruby Chestplate"); register.addName(rubylegs, "Ruby Leggins");
     * register.addName(rubyboots, "Ruby Boots"); // uriotyke
     ...
     * register.addName(uriotykeboots, "Uriotyke Boots"); // gilder
     ...
     * register.addName(gilderboots, "Gilder Boots"); // selovar
     ...
     * register.addName(selovarboots, "Selovar Boots"); // parfilian
     ...
     * register.addName(parfilianboots, "Parfilian Boots"); // barium
     ...
     * register.addName(bariumboots, "Barium Boots"); // radium
     ...
     * register.addName(radiumboots, "Radium Boots"); // gallum
     ...
     * register.addName(gallumboots, "Gallum Boots"); // vanadium
     ...
     * register.addName(vanadiumboots, "Vanadium Boots"); // scandium
     ...
     * register.addName(scandiumboots, "Scandium Boots"); // bismuth
     ...
     * register.addName(bismuthboots, "Bismuth Boots"); // indium
     ...
     * register.addName(indiumboots, "Indium Boots"); // platinum
     ...
     * register.addName(platinumboots, "Platinum Boots"); // darkness
     ...
     * register.addName(darknessboots, "Darkness Boots"); // light
     * register.addName(lighthelm, "Light Helmet"); register.addName(lightplate,
     * "Light Chestplate"); register.addName(lightlegs, "Light Leggins");
     * register.addName(lightboots, "Light Boots"); // omega
     * register.addName(omegahelm, "Omega Helmet"); register.addName(omegaplate,
     * "Omega Chestplate"); register.addName(omegalegs, "Omega Leggins");
     * register.addName(omegaboots, "Omega Boots"); // berionvar
     ...
     * register.addName(berionvarboots, "Berionvar Boots"); // charviole
     ...
     * register.addName(charvioleboots, "Charviole Boots"); // firlvear
     ...
     * register.addName(firlvearboots, "Firlvear Boots"); // selmenrer
     ...
     * register.addName(selmenrerboots, "Selmenrer Boots"); // verilion
     ...
     * register.addName(verilionboots, "Verilion Boots"); // vielvor
     ...
     * register.addName(vielvorboots, "Vielvor Boots"); // invisible
