...
public class ItemHandler {
    ...
    /*
     * public static void setNames(LanguageRegistry registry) { for (int ix = 0;
     * ix < 16; ix++) { // meta set 1 ItemStack urotarkitemStack = new
     * ItemStack(urotark, 1, ix); LanguageRegistry.addName(urotarkitemStack,
     * urotarkItemNames[urotarkitemStack.getItemDamage()]); // meta set 3
     * ItemStack urotarkingotitemStack = new ItemStack(urotarkingot, 1, ix);
     * LanguageRegistry.addName(urotarkingotitemStack,
     * urotarkingotItemNames[urotarkingotitemStack.getItemDamage()]);
     * 
     * }
     * 
     * for (int ix = 0; ix < 12; ix++) { // meta set 2 ItemStack
     * platinumitemStack = new ItemStack(platinum, 1, ix);
     * LanguageRegistry.addName(platinumitemStack,
     * platinumItemNames[platinumitemStack.getItemDamage()]); // meta set 4
     * ItemStack platinumingotitemStack = new ItemStack(platinumingot, 1, ix);
     * LanguageRegistry.addName(platinumingotitemStack,
     * platinumingotItemNames[platinumingotitemStack.getItemDamage()]);
     * 
     * } // darkness registry.addName(darknessshard, "Darkness Shard"); // light
     * registry.addName(lightshard, "Light Shard"); // omega
     * registry.addName(omegashards, "Omega Shards"); // New darkenss
