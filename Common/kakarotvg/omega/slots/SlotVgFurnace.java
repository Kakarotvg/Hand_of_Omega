...
public class SlotVgFurnace extends Slot {
    /**
    ...
    public SlotVgFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5) {
    ...
    protected void onCrafting(ItemStack par1ItemStack) {
        ...
        if (!this.thePlayer.worldObj.isRemote) {
            ...
            float f = ComputerRecipes.smelting().func_151398_b(par1ItemStack);
            int j;
